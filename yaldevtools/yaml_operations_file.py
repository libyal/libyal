...
class YAMLGeneratorOperationsFile:
    ...
    * TODO: describe additional values.
    ...
    _SUPPORTED_KEYS_TYPE_GROUP = frozenset(
        ["condition", "identifier", "modifiers", "operations", "type"]
    )

    _SUPPORTED_KEYS_TYPE_SELECTION = frozenset(
        ["condition", "default", "identifier", "input", "modifiers", "options", "type"]
    )
    ...
    _SUPPORTED_KEYS = (
        set(_SUPPORTED_KEYS_TYPE_GROUP)
        .union(_SUPPORTED_KEYS_TYPE_SELECTION)
        .union(_SUPPORTED_KEYS_TYPE_SEQUENCE)
        .union(_SUPPORTED_KEYS_TYPE_TEMPLATE)
    )

    _SUPPORTED_TYPES = frozenset(["group", "selection", "sequence", "template"])
