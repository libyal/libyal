...
class ToolSourceFileGenerator(interface.SourceFileGenerator):
    ...
    def _GenerateMountFileEntryHeaderFile(
        ...
        # TODO: set option via configuration
        if project_configuration.library_name not in ("libfsext", "libfsfat"):
        ...
        template_names.extend(
            [
                "get_creation_time.h",
                "get_access_time.h",
                "get_modification_time.h",
                "get_inode_change_time.h",
                "get_file_mode.h",
                "get_name_size.h",
                "get_name.h",
            ]
        ...
        template_names.extend(
            [
                "get_sub_file_entries.h",
                "read_buffer_at_offset.h",
                "get_size.h",
                "footer.h",
            ]
        )
    ...
    def _GenerateMountFileEntrySourceFile(
        ...
        del template_mappings["mount_tool_file_entry_creation_time_value_description"]
    ...
    def _GenerateMountFileSystemHeaderFile(
        ...
        if not project_configuration.mount_tool_file_system_type:
            ...
            template_names.extend(["set_file_system_type.h", "get_file_system_type.h"])
    ...
    def _GenerateMountFileSystemSourceFile(
        ...
        if not project_configuration.mount_tool_file_system_type:
            ...
            template_names.extend(
                [
                    "signal_abort-file_system_type.c",
                    "set_file_system_type.c",
        ...
        if not project_configuration.mount_tool_file_system_type:
            template_names.extend(
                [
                    "get_number_of_file_entry_types.c",
                    "get_file_entry_type_by_index.c",
                    "get_file_entry_type_by_path.c",
                    "append_file_entry_type.c",
    ...
    def _GenerateMountFuseSourceFile(
        ...
        template_names.extend(["opendir.c", "readdir.c", "releasedir.c", "getattr.c"])
    ...
    def _GenerateMountToolSourceMainFunction(
        ...
        template_names.extend(["main-fuse-end.c", "main-dokan.c", "main-on_error.c"])
    ...
    def Generate(self, project_configuration, output_writer):
        ...
        self._GenerateInfoTool(project_configuration, template_mappings, output_writer)

        self._GenerateMountTool(project_configuration, template_mappings, output_writer)
