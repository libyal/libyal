...
class TestSourceFileGenerator(interface.SourceFileGenerator):
    ...
    def _GenerateTypeTestFunction(
        ...
        if io_handle_argument_string == (
            f"{project_configuration.library_name:s}_io_handle_t *io_handle"
        ):
            with_io_handle = True
    ...
    def _GenerateTypeTests(
            ...
            for function_prototype in header_file.functions_per_name.values():
                ...
                if len(function_prototype.arguments) >= 2:
                    ...
                    if (
                        ...
                        == "{0:s}_io_handle_t *io_handle".format(
        ...
        if (
            ...
            and type_name in ("context", "tweaked_context")
        ) or (
            project_configuration.library_name == "libcthreads"
            and type_name
            in (
            ...
            template_names.append(
                f"start_{project_configuration.library_name_suffix:s}_{type_name:s}.c"
            )
        ...
        function_name_prefix = f"{project_configuration.library_name:s}_{type_name:s}_"
            ...
            for option, argument in test_options:
                ...
                if argument == "offset":
                    ...
                    variable_declaration = (
                        "\tsystem_character_t *option_{0:s} = NULL;"
                    ).format(argument)
                    test_options_variable_declarations.append(variable_declaration)
    ...
    def _GetTestFunctionName(self, project_configuration, type_name, type_function):
        ...
        if type_function.startswith("internal_"):
            return "{0:s}_test_internal_{1:s}_{2:s}".format(
                project_configuration.library_name_suffix, type_name, type_function[9:]
            )
