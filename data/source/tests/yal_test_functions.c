...
{
	static char *function     = "${library_name_suffix}_test_get_narrow_source";
...
int ${library_name_suffix}_test_get_wide_source(
     ...
     libcerror_error_t **error )
{
	static char *function   = "${library_name_suffix}_test_get_wide_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int ${library_name_suffix}_test_system_string_copy_from_64_bit_in_decimal(
     const system_character_t *string,
     size_t string_size,
     uint64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function              = "${library_name_suffix}_test_system_string_copy_from_64_bit_in_decimal";
