...
#if !defined( _${library_name_suffix_upper_case}_TEST_LIBBFIO_H )
#define _${library_name_suffix_upper_case}_TEST_LIBBFIO_H
...
#endif /* !defined( _${library_name_suffix_upper_case}_TEST_LIBBFIO_H ) */
