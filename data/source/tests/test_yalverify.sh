...
run_test_on_input_directory "${library_name_suffix}verify" "${library_name_suffix}verify" "with_stdout_reference" "$${OPTION_SETS}" "$${TEST_EXECUTABLE}" "input" "$${INPUT_GLOB}" "$${OPTIONS}";
RESULT=$$?;
