...
uint8_t ${library_name_suffix}_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the ${library_name}_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int ${library_name_suffix}_test_huffman_tree_initialize(
     void )
{
	libcerror_error_t *error             = NULL;
	${library_name}_huffman_tree_t *huffman_tree = NULL;
	int result                           = 0;
	...
	huffman_tree = (${library_name}_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test ${library_name}_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test ${library_name}_huffman_tree_initialize with memset failing
		 */
...
/* Tests the ${library_name}_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int ${library_name_suffix}_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the ${library_name}_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int ${library_name_suffix}_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = ${library_name}_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test ${library_name}_huffman_tree_build with malloc failing
	 */
	...
	/* Test ${library_name}_huffman_tree_build with memset failing
	 */
...
/* Tests the ${library_name}_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int ${library_name_suffix}_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = ${library_name}_bit_stream_initialize(
	          &bit_stream,
	          ${library_name_suffix}_test_huffman_tree_data,
	          2627,
	          2,
	...
	result = ${library_name}_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
	...
	${library_name_suffix:upper_case}_TEST_ASSERT_EQUAL_UINT16(
	 "symbol",
	 symbol,
	 (uint16_t) 141 );
...
#endif
{
	...
	${library_name_suffix:upper_case}_TEST_RUN(
	 "${library_name}_huffman_tree_initialize",
	 ${library_name_suffix}_test_huffman_tree_initialize );

	${library_name_suffix:upper_case}_TEST_RUN(
	 "${library_name}_huffman_tree_free",
	 ${library_name_suffix}_test_huffman_tree_free );

	${library_name_suffix:upper_case}_TEST_RUN(
	 "${library_name}_huffman_tree_build",
	 ${library_name_suffix}_test_huffman_tree_build );

	${library_name_suffix:upper_case}_TEST_RUN(
	 "${library_name}_huffman_tree_get_symbol_from_bit_stream",
	 ${library_name_suffix}_test_huffman_tree_get_symbol_from_bit_stream );
