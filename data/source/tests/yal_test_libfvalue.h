...
#if !defined( _${library_name_suffix:upper_case}_TEST_LIBFVALUE_H )
#define _${library_name_suffix:upper_case}_TEST_LIBFVALUE_H
...
#endif /* !defined( _${library_name_suffix:upper_case}_TEST_LIBFVALUE_H ) */
