...
run_test_on_input_directory "${library_name_suffix}export" "${library_name_suffix}export" "with_stdout_reference" "$${OPTION_SETS}" "$${TEST_EXECUTABLE}" "input" "$${INPUT_GLOB}" "$${OPTIONS}";
RESULT=$$?;
