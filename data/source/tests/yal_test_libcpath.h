...
#if !defined( _${library_name_suffix:upper_case}_TEST_LIBCPATH_H )
#define _${library_name_suffix:upper_case}_TEST_LIBCPATH_H
...
#endif /* !defined( _${library_name_suffix:upper_case}_TEST_LIBCPATH_H ) */
