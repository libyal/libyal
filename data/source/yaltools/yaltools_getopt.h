...
typedef struct ${tools_name}_option ${tools_name}_option_t;

struct ${tools_name}_option
{
...
#define ${tools_name}_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t ${tools_name}_getopt(
                  int argument_count,
...
void ${tools_name}_getopt_wrapped_fprint(
      FILE *stream,
...
void ${tools_name}_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const ${tools_name}_option_t *options,
      int number_of_options );

int ${tools_name}_getopt_get_options_string(
     const ${tools_name}_option_t *options,
     int number_of_options,
