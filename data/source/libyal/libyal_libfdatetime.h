...
#if !defined( _${library_name:upper_case}_LIBFDATETIME_H )
#define _${library_name:upper_case}_LIBFDATETIME_H
...
#endif /* !defined( _${library_name:upper_case}_LIBFDATETIME_H ) */
