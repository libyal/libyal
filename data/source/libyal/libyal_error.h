...
#if !defined( _${library_name:upper_case}_INTERNAL_ERROR_H )
#define _${library_name:upper_case}_INTERNAL_ERROR_H
...
#endif /* !defined( _${library_name:upper_case}_INTERNAL_ERROR_H ) */
