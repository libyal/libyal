...
#include "${python_module_name}_file_object_io_handle.h"
#include "${python_module_name}_integer.h"
...
{
	static char *function = "${python_module_name}_file_object_io_handle_initialize";
	...
	*file_object_io_handle = (${python_module_name}_file_object_io_handle_t *) PyMem_Malloc(
	                                                            ${alignment_padding}sizeof( ${python_module_name}_file_object_io_handle_t ) );
	...
	if( memory_set(
	     *file_object_io_handle,
	     0,
	     sizeof( ${python_module_name}_file_object_io_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int ${python_module_name}_file_object_initialize(
     ...
     libcerror_error_t **error )
{
	${python_module_name}_file_object_io_handle_t *file_object_io_handle = NULL;
	static char *function                                ${alignment_padding}= "${python_module_name}_file_object_initialize";
	...
	if( ${python_module_name}_file_object_io_handle_initialize(
	     &file_object_io_handle,
	     file_object,
	     error ) != 1 )
	{
	...
	if( libbfio_handle_initialize(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_free,
	     (int (*)(intptr_t **, intptr_t *, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_clone,
	     (int (*)(intptr_t *, int, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_open,
	     (int (*)(intptr_t *, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_close,
	     (ssize_t (*)(intptr_t *, uint8_t *, size_t, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_read,
	     (ssize_t (*)(intptr_t *, const uint8_t *, size_t, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_write,
	     (off64_t (*)(intptr_t *, off64_t, int, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_seek_offset,
	     (int (*)(intptr_t *, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_exists,
	     (int (*)(intptr_t *, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_is_open,
	     (int (*)(intptr_t *, size64_t *, libcerror_error_t **)) ${python_module_name}_file_object_io_handle_get_size,
...
on_error:
	if( file_object_io_handle != NULL )
	{
		${python_module_name}_file_object_io_handle_free(
		 &file_object_io_handle,
		 NULL );
	}
	return( -1 );
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "${python_module_name}_file_object_io_handle_free";
...
int ${python_module_name}_file_object_io_handle_clone(
     ...
     libcerror_error_t **error )
{
	static char *function = "${python_module_name}_file_object_io_handle_clone";
...
int ${python_module_name}_file_object_io_handle_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "${python_module_name}_file_object_io_handle_open";
...
int ${python_module_name}_file_object_io_handle_close(
     ...
     libcerror_error_t **error )
{
	static char *function = "${python_module_name}_file_object_io_handle_close";
         ...
         libcerror_error_t **error )
{
	...
	static char *function      = "${python_module_name}_file_object_read_buffer";
	...
	if( size > 0 )
	{
		...
		if( PyErr_Occurred() )
		{
			${python_module_name}_error_fetch(
			 error,
...
ssize_t ${python_module_name}_file_object_io_handle_read(
         ...
         libcerror_error_t **error )
{
	static char *function      = "${python_module_name}_file_object_io_handle_read";
	PyGILState_STATE gil_state = 0;
	ssize_t read_count         = 0;
	...
	read_count = ${python_module_name}_file_object_read_buffer(
	              file_object_io_handle->file_object,
	              buffer,
	              size,
	              error );
         ...
         libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "${python_module_name}_file_object_write_buffer";
...
ssize_t ${python_module_name}_file_object_io_handle_write(
         ...
         libcerror_error_t **error )
{
	static char *function      = "${python_module_name}_file_object_io_handle_write";
	PyGILState_STATE gil_state = 0;
	...
	write_count = ${python_module_name}_file_object_write_buffer(
	               file_object_io_handle->file_object,
	               buffer,
	               size,
	               error );
     ...
     libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "${python_module_name}_file_object_seek_offset";
     ...
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "${python_module_name}_file_object_get_offset";
	int result              = 0;
...
off64_t ${python_module_name}_file_object_io_handle_seek_offset(
         ...
         libcerror_error_t **error )
{
	static char *function      = "${python_module_name}_file_object_io_handle_seek_offset";
	PyGILState_STATE gil_state = 0;
	...
	if( ${python_module_name}_file_object_seek_offset(
	     file_object_io_handle->file_object,
	     offset,
	     whence,
	     error ) != 1 )
	...
	if( ${python_module_name}_file_object_get_offset(
	     file_object_io_handle->file_object,
	     &offset,
	     error ) != 1 )
	{
...
int ${python_module_name}_file_object_io_handle_exists(
     ...
     libcerror_error_t **error )
{
	static char *function = "${python_module_name}_file_object_io_handle_exists";
...
int ${python_module_name}_file_object_io_handle_is_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "${python_module_name}_file_object_io_handle_is_open";
     ...
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "${python_module_name}_file_object_get_size";
...
{
	PyObject *method_name      = NULL;
	static char *function      = "${python_module_name}_file_object_io_handle_get_size";
	...
	if( result != 0 )
	{
		if( ${python_module_name}_file_object_get_size(
		     file_object_io_handle->file_object,
		     size,
		     error ) != 1 )
		{
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			...
			${python_module_name}_file_object_seek_offset(
			 file_object_io_handle->file_object,
			 current_offset,
			 SEEK_SET,
			 NULL );
