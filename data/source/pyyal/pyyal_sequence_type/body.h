...
#if !defined( _${python_module_name:upper_case}_${sequence_type_name:upper_case}_H )
#define _${python_module_name:upper_case}_${sequence_type_name:upper_case}_H
...
#endif /* !defined( _${python_module_name:upper_case}_${sequence_type_name:upper_case}_H ) */
