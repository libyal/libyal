           ...
           int64_t value_64bit )
{
	...
	static char *function    = "${python_module_name}_integer_signed_new_from_64bit";
...
{
	PyObject *integer_object = NULL;
	static char *function    = "${python_module_name}_integer_unsigned_new_from_64bit";
...
{
	static char *function   = "${python_module_name}_integer_signed_copy_to_64bit";
	int result              = 0;
...
int ${python_module_name}_integer_unsigned_copy_to_64bit(
     ...
     libcerror_error_t **error )
{
	static char *function   = "${python_module_name}_integer_unsigned_copy_to_64bit";
	int result              = 0;
