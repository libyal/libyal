...
#if !defined( _${python_module_name:upper_case}_ERROR_H )
#define _${python_module_name:upper_case}_ERROR_H
...
#define ${python_module_name:upper_case}_ERROR_STRING_SIZE	2048
...
#endif /* !defined( _${python_module_name:upper_case}_ERROR_H ) */
